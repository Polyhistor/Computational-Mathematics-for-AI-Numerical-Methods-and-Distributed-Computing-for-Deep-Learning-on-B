...
\addplot [fill=blue!60] coordinates {(Healthcare, 27.4) (Cybersecurity, 18.2) (Financial, 16.7) (Manufacturing, 19.3)};
\addplot [fill=red!60] coordinates {(Healthcare, 12.6) (Cybersecurity, 24.8) (Financial, 14.9) (Manufacturing, 18.5)};
\addplot [fill=green!60] coordinates {(Healthcare, 16.8) (Cybersecurity, 14.3) (Financial, 23.5) (Manufacturing, 17.8)};
\addplot [fill=yellow!60] coordinates {(Healthcare, 10.5) (Cybersecurity, 15.6) (Financial, 11.2) (Manufacturing, 15.9)};
...
\addplot [fill=blue!60] coordinates {(Gradient-based, 8.7) (Bayesian, 7.2) (Evolutionary, 4.3) (Nature-inspired, 2.8)};
\end{axis}
\end{tikzpicture}
...
% Scatter points for individual papers
\addplot[only marks, mark=o, mark size=2pt, color=blue!60] coordinates {
    (1.2, 19.4) (1.8, 15.2) (2.1, 21.7) (2.3, 24.3) (2.5, 17.8)
    (2.7, 23.1) (2.9, 19.5) (3.2, 18.2) (3.5, 22.6) (3.7, 15.9)
    (3.9, 17.3) (4.1, 16.2) (4.3, 14.5) (4.6, 13.8) (4.9, 16.5)
    (5.2, 17.2) (5.4, 15.8) (5.7, 14.9) (5.9, 13.7) (6.2, 15.3)
    (6.5, 13.2) (6.8, 14.1) (7.1, 15.6) (7.4, 12.8) (7.7, 14.7)
    (8.1, 13.5) (8.4, 12.9) (8.7, 11.8) (9.1, 12.3) (9.4, 10.5)
    (9.7, 11.2) (10.1, 9.7) (10.3, 10.8) (10.6, 9.3) (10.9, 9.8)
    (11.2, 8.5) (11.4, 9.1) (11.7, 8.2)
};

% Trend line
\addplot[color=red, domain=0:12, thick] {22 - 1.2*x};
